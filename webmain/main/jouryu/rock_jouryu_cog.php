...
$(document).ready(function(){
	...
	var c={
		...
		kusnsegeo:function(ips){
			...
			get('receid_{rand}').value='rockjouryu';
...
<div  style="padding:10px;">
		...
		<tr>
			...
			<td class="tdinput"><input id="push_{rand}"  style="width:300px" readonly class="form-control"><br><font color=#888888>用于推送到琢瑜OA客户端,http://开头</font></td>
		</tr>
