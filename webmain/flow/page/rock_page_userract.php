...
$(document).ready(function(){
	...
	var c = {
		...
		daoru:function(){
			...
			addtabs({num:'daoruuserract',url:'flow,input,daoru,modenum=userract',icons:'plus',name:'导入员工合同'});
		},
	...
	var bootparams = {
		...
		params:{atype:atype},
		columns:[{text:"签署人",dataIndex:"uname"},{text:"部门",dataIndex:"deptname"},{text:"合同名称",dataIndex:"name"},{text:"签署单位",dataIndex:"company"},{text:"合同类型",dataIndex:"httype"},{text:"开始日期",dataIndex:"startdt"},{text:"截止日期",dataIndex:"enddt"},{text:"状态",dataIndex:"state"},{text:"提前终止日期",dataIndex:"tqenddt"},{text:"说明",dataIndex:"explain"},{
