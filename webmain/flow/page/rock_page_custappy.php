...
*	来源：流程模块→表单元素管理→[模块.客户申请使用]→生成列表页
*/
...
$(document).ready(function(){
	{params}
	var modenum = 'custappy',modename='客户申请使用',isflow=1,modeid='77',atype = params.atype,pnum=params.pnum;
	if(!atype)atype='';if(!pnum)pnum='';
	var fieldsarr = [{"name":"\u7533\u8bf7\u4eba","fields":"base_name"},{"name":"\u7533\u8bf7\u4eba\u90e8\u95e8","fields":"base_deptname"},{"name":"\u5355\u53f7","fields":"sericnum"},{"fields":"custname","name":"\u5ba2\u6237\u540d\u79f0","fieldstype":"selectdatafalse","ispx":"0","isalign":"0","islb":"1"},{"fields":"custid","name":"\u5ba2\u6237ID","fieldstype":"hidden","ispx":"0","isalign":"0","islb":"0"},{"fields":"explain","name":"\u8bf4\u660e","fieldstype":"textarea","ispx":"1","isalign":"0","islb":"1"}],fieldsselarr= [];
	...
	var c = {
		...
		subscribelist:function(){
			js.subscribe({
				title:'客户申请使用('+nowtabs.name+')',
				cont:'客户申请使用('+nowtabs.name+')的列表的',
				explain:'订阅[客户申请使用]的列表',
				objtable:a
			});
		},
		getacturl:function(act){
			return js.getajaxurl(act,'mode_custappy|input','flow',{'modeid':modeid});
		},
		...
		daoru:function(){
			window.managelistcustappy = a;
			addtabs({num:'daorucustappy',url:'flow,input,daoru,modenum=custappy',icons:'plus',name:'导入客户申请使用'});
		},
	...
	//表格参数设定
	var bootparams = {
		fanye:true,modenum:modenum,modename:modename,statuschange:false,tablename:jm.base64decode('Y3VzdGFwcHk:'),
		url:c.storeurl(),storeafteraction:'storeaftershow',storebeforeaction:'storebeforeshow',
		params:{atype:atype},
		columns:[{text:"申请人",dataIndex:"base_name",sortable:true},{text:"申请人部门",dataIndex:"base_deptname",sortable:true},{text:"单号",dataIndex:"sericnum"},{text:"客户名称",dataIndex:"custname"},{text:"说明",dataIndex:"explain",sortable:true},{text:"状态",dataIndex:"statustext"},{
...
//[自定义区域end]
	...
	js.initbtn(c);
	var a = $('#viewcustappy_{rand}').bootstable(bootparams);
	c.init();
