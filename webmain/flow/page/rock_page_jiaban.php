...
$(document).ready(function(){
	{params}
	var modenum = 'jiaban',modename='加班单',isflow=1,modeid='6',atype = params.atype,pnum=params.pnum;
	if(!atype)atype='';if(!pnum)pnum='';
	var fieldsarr = [{"name":"\u7533\u8bf7\u4eba","fields":"base_name"},{"name":"\u7533\u8bf7\u4eba\u90e8\u95e8","fields":"base_deptname"},{"name":"\u5355\u53f7","fields":"sericnum"},{"fields":"kind","name":"\u7c7b\u578b","fieldstype":"fixed","ispx":"0","isalign":"0","islb":"0"},{"fields":"uname","name":"\u7533\u8bf7\u4eba","fieldstype":"changeuser","ispx":"0","isalign":"0","islb":"0"},{"fields":"stime","name":"\u5f00\u59cb\u65f6\u95f4","fieldstype":"datetime","ispx":"0","isalign":"0","islb":"1"},{"fields":"etime","name":"\u622a\u6b62\u65f6\u95f4","fieldstype":"datetime","ispx":"0","isalign":"0","islb":"1"},{"fields":"totals","name":"\u65f6\u95f4(\u5c0f\u65f6)","fieldstype":"number","ispx":"0","isalign":"0","islb":"1"},{"fields":"explain","name":"\u8bf4\u660e","fieldstype":"textarea","ispx":"0","isalign":"1","islb":"1"},{"fields":"jiatype","name":"\u52a0\u73ed\u5151\u6362","fieldstype":"select","ispx":"1","isalign":"0","islb":"1"},{"fields":"jiafee","name":"\u52a0\u73ed\u8d39","fieldstype":"number","ispx":"1","isalign":"0","islb":"1"}],fieldsselarr= [];
	...
	var c = {
		...
		subscribelist:function(){
			js.subscribe({
				title:'加班单('+nowtabs.name+')',
				cont:'加班单('+nowtabs.name+')的列表的',
				explain:'订阅[加班单]的列表',
				objtable:a
			});
		},
		getacturl:function(act){
			return js.getajaxurl(act,'mode_jiaban|input','flow',{'modeid':modeid});
		},
		...
		daoru:function(){
			window.managelistjiaban = a;
			addtabs({num:'daorujiaban',url:'flow,input,daoru,modenum=jiaban',icons:'plus',name:'导入加班单'});
		},
	...
	//表格参数设定
	var bootparams = {
		fanye:true,modenum:modenum,modename:modename,statuschange:false,tablename:jm.base64decode('a3FpbmZv'),
		url:c.storeurl(),storeafteraction:'storeaftershow',storebeforeaction:'storebeforeshow',
		params:{atype:atype},
		columns:[{text:"申请人",dataIndex:"base_name",sortable:true},{text:"申请人部门",dataIndex:"base_deptname",sortable:true},{text:"单号",dataIndex:"sericnum"},{text:"开始时间",dataIndex:"stime"},{text:"截止时间",dataIndex:"etime"},{text:"时间(小时)",dataIndex:"totals"},{text:"说明",dataIndex:"explain",align:"left"},{text:"加班兑换",dataIndex:"jiatype",sortable:true},{text:"加班费",dataIndex:"jiafee",sortable:true},{text:"状态",dataIndex:"statustext"},{
...
//[自定义区域end]
	...
	js.initbtn(c);
	var a = $('#viewjiaban_{rand}').bootstable(bootparams);
	c.init();
