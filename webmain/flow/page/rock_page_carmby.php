...
$(document).ready(function(){
	...
	var c = {
		...
		subscribelist:function(){
			js.subscribe({
				title:'车辆保养('+nowtabs.name+')',
				cont:'车辆保养('+nowtabs.name+')的列表的',
				explain:'订阅[车辆保养]的列表',
				objtable:a
			});
		},
		getacturl:function(act){
			return js.getajaxurl(act,'mode_carmby|input','flow',{'modeid':modeid});
		},
		...
		daoru:function(){
			window.managelistcarmby = a;
			addtabs({num:'daorucarmby',url:'flow,input,daoru,modenum=carmby',icons:'plus',name:'导入车辆保养'});
		},
	...
	var bootparams = {
		...
		params:{atype:atype},
		columns:[{text:"申请人",dataIndex:"base_name",sortable:true},{text:"申请人部门",dataIndex:"base_deptname",sortable:true},{text:"单号",dataIndex:"sericnum"},{text:"保养车辆",dataIndex:"carid",sortable:true},{text:"驾驶员",dataIndex:"jianame"},{text:"保养原因",dataIndex:"reason"},{text:"保养地点",dataIndex:"address"},{text:"保养内容",dataIndex:"bujian"},{text:"保养时间",dataIndex:"startdt"},{text:"取车时间",dataIndex:"enddt",sortable:true},{text:"保养金额",dataIndex:"money"},{text:"下次保养日期",dataIndex:"nextdt"},{text:"状态",dataIndex:"statustext"},{
...
//[自定义区域end]
	...
	js.initbtn(c);
	var a = $('#viewcarmby_{rand}').bootstable(bootparams);
	c.init();
