...
$(document).ready(function(){
	{params}
	var modenum = 'waichu',modename='外出出差',isflow=1,modeid='23',atype = params.atype,pnum=params.pnum;
	if(!atype)atype='';if(!pnum)pnum='';
	var fieldsarr = [{"name":"\u7533\u8bf7\u4eba","fields":"base_name"},{"name":"\u7533\u8bf7\u4eba\u90e8\u95e8","fields":"base_deptname"},{"name":"\u5355\u53f7","fields":"sericnum"},{"fields":"applyname","name":"\u7533\u8bf7\u4eba","fieldstype":"changeuser","ispx":"0","isalign":"0","islb":"0"},{"fields":"atype","name":"\u7c7b\u578b","fieldstype":"select","ispx":"0","isalign":"0","islb":"1"},{"fields":"address","name":"\u5916\u51fa\u5730\u5740","fieldstype":"text","ispx":"0","isalign":"0","islb":"1"},{"fields":"outtime","name":"\u5916\u51fa\u65f6\u95f4","fieldstype":"datetime","ispx":"1","isalign":"0","islb":"1"},{"fields":"intime","name":"\u9884\u8ba1\u56de\u5c97","fieldstype":"datetime","ispx":"0","isalign":"0","islb":"1"},{"fields":"reason","name":"\u5916\u51fa\u7406\u7531","fieldstype":"text","ispx":"0","isalign":"1","islb":"1"},{"fields":"explain","name":"\u8bf4\u660e","fieldstype":"textarea","ispx":"0","isalign":"1","islb":"1"}],fieldsselarr= [];
	...
	var c = {
		...
		subscribelist:function(){
			js.subscribe({
				title:'外出出差('+nowtabs.name+')',
				cont:'外出出差('+nowtabs.name+')的列表的',
				explain:'订阅[外出出差]的列表',
				objtable:a
			});
		},
		getacturl:function(act){
			return js.getajaxurl(act,'mode_waichu|input','flow',{'modeid':modeid});
		},
		...
		daoru:function(){
			window.managelistwaichu = a;
			addtabs({num:'daoruwaichu',url:'flow,input,daoru,modenum=waichu',icons:'plus',name:'导入外出出差'});
		},
	...
	//表格参数设定
	var bootparams = {
		fanye:true,modenum:modenum,modename:modename,statuschange:false,tablename:jm.base64decode('a3FvdXQ:'),
		url:c.storeurl(),storeafteraction:'storeaftershow',storebeforeaction:'storebeforeshow',
		params:{atype:atype},
		columns:[{text:"申请人",dataIndex:"base_name",sortable:true},{text:"申请人部门",dataIndex:"base_deptname",sortable:true},{text:"单号",dataIndex:"sericnum"},{text:"类型",dataIndex:"atype"},{text:"外出地址",dataIndex:"address"},{text:"外出时间",dataIndex:"outtime",sortable:true},{text:"预计回岗",dataIndex:"intime"},{text:"外出理由",dataIndex:"reason",align:"left"},{text:"说明",dataIndex:"explain",align:"left"},{text:"状态",dataIndex:"statustext"},{
...
//[自定义区域end]
	...
	js.initbtn(c);
	var a = $('#viewwaichu_{rand}').bootstable(bootparams);
	c.init();
