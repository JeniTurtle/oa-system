...
$(document).ready(function(){
	{params}
	var modenum = 'finhkd',modename='还款单',isflow=1,modeid='27',atype = params.atype,pnum=params.pnum;
	if(!atype)atype='';if(!pnum)pnum='';
	var fieldsarr = [{"name":"\u7533\u8bf7\u4eba","fields":"base_name"},{"name":"\u7533\u8bf7\u4eba\u90e8\u95e8","fields":"base_deptname"},{"name":"\u5355\u53f7","fields":"sericnum"},{"fields":"type","name":"\u7c7b\u578b","fieldstype":"fixed","ispx":"0","isalign":"0","islb":"0"},{"fields":"applydt","name":"\u7533\u8bf7\u65e5\u671f","fieldstype":"text","ispx":"1","isalign":"0","islb":"1"},{"fields":"paytype","name":"\u4ed8\u6b3e\u65b9\u5f0f","fieldstype":"rockcombo","ispx":"0","isalign":"0","islb":"1"},{"fields":"fullname","name":"\u6536\u6b3e\u4eba\u5168\u79f0","fieldstype":"text","ispx":"0","isalign":"0","islb":"1"},{"fields":"cardid","name":"\u6536\u6b3e\u5e10\u53f7","fieldstype":"text","ispx":"0","isalign":"0","islb":"1"},{"fields":"money","name":"\u8fd8\u6b3e\u91d1\u989d","fieldstype":"number","ispx":"1","isalign":"0","islb":"1"},{"fields":"moneycn","name":"\u8fd8\u6b3e\u91d1\u989d\u5927\u5199","fieldstype":"text","ispx":"0","isalign":"0","islb":"0"},{"fields":"explain","name":"\u8bf4\u660e","fieldstype":"textarea","ispx":"0","isalign":"0","islb":"1"},{"fields":"temp_money","name":"\u9700\u8fd8\u6b3e\u91d1\u989d","fieldstype":"auto","ispx":"0","isalign":"0","islb":"0"}],fieldsselarr= [];
	...
	var c = {
		...
		subscribelist:function(){
			js.subscribe({
				title:'还款单('+nowtabs.name+')',
				cont:'还款单('+nowtabs.name+')的列表的',
				explain:'订阅[还款单]的列表',
				objtable:a
			});
		},
		getacturl:function(act){
			return js.getajaxurl(act,'mode_finhkd|input','flow',{'modeid':modeid});
		},
		...
		daoru:function(){
			window.managelistfinhkd = a;
			addtabs({num:'daorufinhkd',url:'flow,input,daoru,modenum=finhkd',icons:'plus',name:'导入还款单'});
		},
	...
	var bootparams = {
		...
		params:{atype:atype},
		columns:[{text:"申请人",dataIndex:"base_name",sortable:true},{text:"申请人部门",dataIndex:"base_deptname",sortable:true},{text:"单号",dataIndex:"sericnum"},{text:"申请日期",dataIndex:"applydt",sortable:true},{text:"付款方式",dataIndex:"paytype"},{text:"收款人全称",dataIndex:"fullname"},{text:"收款帐号",dataIndex:"cardid"},{text:"还款金额",dataIndex:"money",sortable:true},{text:"说明",dataIndex:"explain"},{text:"状态",dataIndex:"statustext"},{
...
//[自定义区域end]
	...
	js.initbtn(c);
	var a = $('#viewfinhkd_{rand}').bootstable(bootparams);
	c.init();
