...
$(document).ready(function(){
	...
	var c = {
		...
		subscribelist:function(){
			js.subscribe({
				title:'面试安排('+nowtabs.name+')',
				cont:'面试安排('+nowtabs.name+')的列表的',
				explain:'订阅[面试安排]的列表',
				objtable:a
			});
		},
		getacturl:function(act){
			return js.getajaxurl(act,'mode_hrmanshi|input','flow',{'modeid':modeid});
		},
		...
		daoru:function(){
			window.managelisthrmanshi = a;
			addtabs({num:'daoruhrmanshi',url:'flow,input,daoru,modenum=hrmanshi',icons:'plus',name:'导入面试安排'});
		},
	...
	var bootparams = {
		...
		params:{atype:atype},
		columns:[{text:"申请人",dataIndex:"base_name",sortable:true},{text:"申请人部门",dataIndex:"base_deptname",sortable:true},{text:"单号",dataIndex:"sericnum"},{text:"面试者",dataIndex:"name"},{text:"面试岗位",dataIndex:"zhiwei"},{text:"所属部门",dataIndex:"bumen"},{text:"面试时间",dataIndex:"msdt"},{text:"面试人员",dataIndex:"msuser"},{text:"面试结果",dataIndex:"state"},{text:"面试记录",dataIndex:"mscont"},{text:"状态",dataIndex:"statustext"},{
...
//[自定义区域end]
	...
	js.initbtn(c);
	var a = $('#viewhrmanshi_{rand}').bootstable(bootparams);
	c.init();
