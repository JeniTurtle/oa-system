...
$(document).ready(function(){
	{params}
	var modenum = 'carmwx',modename='车辆维修',isflow=1,modeid='59',atype = params.atype,pnum=params.pnum;
	if(!atype)atype='';if(!pnum)pnum='';
	var fieldsarr = [{"name":"\u7533\u8bf7\u4eba","fields":"base_name"},{"name":"\u7533\u8bf7\u4eba\u90e8\u95e8","fields":"base_deptname"},{"name":"\u5355\u53f7","fields":"sericnum"},{"fields":"carid","name":"\u7ef4\u4fee\u8f66\u8f86","fieldstype":"select","ispx":"1","isalign":"0","islb":"1"},{"fields":"reason","name":"\u7ef4\u4fee\u539f\u56e0","fieldstype":"textarea","ispx":"0","isalign":"0","islb":"1"},{"fields":"address","name":"\u7ef4\u4fee\u5730\u70b9","fieldstype":"text","ispx":"0","isalign":"0","islb":"1"},{"fields":"jianame","name":"\u9a7e\u9a76\u5458","fieldstype":"changeusercheck","ispx":"0","isalign":"0","islb":"1"},{"fields":"bujian","name":"\u66f4\u6362\u90e8\u4ef6","fieldstype":"text","ispx":"0","isalign":"0","islb":"1"},{"fields":"startdt","name":"\u7ef4\u4fee\u65f6\u95f4","fieldstype":"datetime","ispx":"0","isalign":"0","islb":"1"},{"fields":"enddt","name":"\u7ef4\u4fee\u622a\u6b62\u65f6\u95f4","fieldstype":"datetime","ispx":"1","isalign":"0","islb":"1"},{"fields":"money","name":"\u7ef4\u4fee\u91d1\u989d","fieldstype":"number","ispx":"0","isalign":"0","islb":"1"},{"fields":"explain","name":"\u8bf4\u660e","fieldstype":"textarea","ispx":"0","isalign":"0","islb":"1"}],fieldsselarr= [];
	...
	var c = {
		...
		subscribelist:function(){
			js.subscribe({
				title:'车辆维修('+nowtabs.name+')',
				cont:'车辆维修('+nowtabs.name+')的列表的',
				explain:'订阅[车辆维修]的列表',
				objtable:a
			});
		},
		getacturl:function(act){
			return js.getajaxurl(act,'mode_carmwx|input','flow',{'modeid':modeid});
		},
		...
		daoru:function(){
			window.managelistcarmwx = a;
			addtabs({num:'daorucarmwx',url:'flow,input,daoru,modenum=carmwx',icons:'plus',name:'导入车辆维修'});
		},
	...
	//表格参数设定
	var bootparams = {
		fanye:true,modenum:modenum,modename:modename,statuschange:false,tablename:jm.base64decode('Y2FybWFuZw::'),
		url:c.storeurl(),storeafteraction:'storeaftershow',storebeforeaction:'storebeforeshow',
		params:{atype:atype},
		columns:[{text:"申请人",dataIndex:"base_name",sortable:true},{text:"申请人部门",dataIndex:"base_deptname",sortable:true},{text:"单号",dataIndex:"sericnum"},{text:"维修车辆",dataIndex:"carid",sortable:true},{text:"维修原因",dataIndex:"reason"},{text:"维修地点",dataIndex:"address"},{text:"驾驶员",dataIndex:"jianame"},{text:"更换部件",dataIndex:"bujian"},{text:"维修时间",dataIndex:"startdt"},{text:"维修截止时间",dataIndex:"enddt",sortable:true},{text:"维修金额",dataIndex:"money"},{text:"说明",dataIndex:"explain"},{text:"状态",dataIndex:"statustext"},{
...
//[自定义区域end]
	...
	js.initbtn(c);
	var a = $('#viewcarmwx_{rand}').bootstable(bootparams);
	c.init();
