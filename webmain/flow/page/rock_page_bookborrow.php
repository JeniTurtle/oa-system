...
$(document).ready(function(){
	{params}
	var modenum = 'bookborrow',modename='图书借阅',isflow=1,modeid='46',atype = params.atype,pnum=params.pnum;
	if(!atype)atype='';if(!pnum)pnum='';
	var fieldsarr = [{"name":"\u7533\u8bf7\u4eba","fields":"base_name"},{"name":"\u7533\u8bf7\u4eba\u90e8\u95e8","fields":"base_deptname"},{"name":"\u5355\u53f7","fields":"sericnum"},{"fields":"bookid","name":"\u501f\u9605\u4e66\u540d","fieldstype":"hidden","ispx":"0","isalign":"0","islb":"0"},{"fields":"bookname","name":"\u501f\u9605\u4e66\u540d","fieldstype":"selectdatafalse","ispx":"0","isalign":"0","islb":"1"},{"fields":"jydt","name":"\u501f\u9605\u65e5\u671f","fieldstype":"date","ispx":"1","isalign":"0","islb":"1"},{"fields":"yjdt","name":"\u9884\u8ba1\u5f52\u8fd8","fieldstype":"date","ispx":"1","isalign":"0","islb":"1"},{"fields":"ghtime","name":"\u5f52\u8fd8\u65f6\u95f4","fieldstype":"datetime","ispx":"0","isalign":"0","islb":"1"},{"fields":"isgh","name":"\u662f\u5426\u5f52\u8fd4","fieldstype":"select","ispx":"1","isalign":"0","islb":"1"},{"fields":"explain","name":"\u8bf4\u660e","fieldstype":"textarea","ispx":"0","isalign":"0","islb":"1"}],fieldsselarr= [];
	...
	var c = {
		...
		subscribelist:function(){
			js.subscribe({
				title:'图书借阅('+nowtabs.name+')',
				cont:'图书借阅('+nowtabs.name+')的列表的',
				explain:'订阅[图书借阅]的列表',
				objtable:a
			});
		},
		getacturl:function(act){
			return js.getajaxurl(act,'mode_bookborrow|input','flow',{'modeid':modeid});
		},
		...
		daoru:function(){
			window.managelistbookborrow = a;
			addtabs({num:'daorubookborrow',url:'flow,input,daoru,modenum=bookborrow',icons:'plus',name:'导入图书借阅'});
		},
	...
	//表格参数设定
	var bootparams = {
		fanye:true,modenum:modenum,modename:modename,statuschange:false,tablename:jm.base64decode('Ym9va2JvcnJvdw::'),
		url:c.storeurl(),storeafteraction:'storeaftershow',storebeforeaction:'storebeforeshow',
		params:{atype:atype},
		columns:[{text:"申请人",dataIndex:"base_name",sortable:true},{text:"申请人部门",dataIndex:"base_deptname",sortable:true},{text:"单号",dataIndex:"sericnum"},{text:"借阅书名",dataIndex:"bookname"},{text:"借阅日期",dataIndex:"jydt",sortable:true},{text:"预计归还",dataIndex:"yjdt",sortable:true},{text:"归还时间",dataIndex:"ghtime"},{text:"是否归返",dataIndex:"isgh",sortable:true},{text:"说明",dataIndex:"explain"},{text:"状态",dataIndex:"statustext"},{
...
//[自定义区域end]
	...
	js.initbtn(c);
	var a = $('#viewbookborrow_{rand}').bootstable(bootparams);
	c.init();
