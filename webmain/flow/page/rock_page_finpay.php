...
$(document).ready(function(){
	{params}
	var modenum = 'finpay',modename='付款申请',isflow=1,modeid='64',atype = params.atype,pnum=params.pnum;
	if(!atype)atype='';if(!pnum)pnum='';
	var fieldsarr = [{"name":"\u7533\u8bf7\u4eba","fields":"base_name"},{"name":"\u7533\u8bf7\u4eba\u90e8\u95e8","fields":"base_deptname"},{"name":"\u5355\u53f7","fields":"sericnum"},{"fields":"num","name":"\u4ed8\u6b3e\u7f16\u53f7","fieldstype":"text","ispx":"0","isalign":"0","islb":"1"},{"fields":"money","name":"\u4ed8\u6b3e\u91d1\u989d","fieldstype":"number","ispx":"1","isalign":"0","islb":"1"},{"fields":"paydt","name":"\u4ed8\u6b3e\u65e5\u671f","fieldstype":"date","ispx":"1","isalign":"0","islb":"1"},{"fields":"fullname","name":"\u6536\u6b3e\u5355\u4f4d","fieldstype":"text","ispx":"0","isalign":"0","islb":"1"},{"fields":"openbank","name":"\u6536\u6b3e\u94f6\u884c","fieldstype":"text","ispx":"0","isalign":"0","islb":"1"},{"fields":"cardid","name":"\u6536\u6b3e\u5e10\u53f7","fieldstype":"text","ispx":"0","isalign":"0","islb":"1"},{"fields":"paytype","name":"\u4ed8\u6b3e\u65b9\u5f0f","fieldstype":"rockcombo","ispx":"0","isalign":"0","islb":"1"},{"fields":"explain","name":"\u8bf4\u660e","fieldstype":"textarea","ispx":"0","isalign":"0","islb":"0"},{"fields":"type","name":"\u7c7b\u578b","fieldstype":"fixed","ispx":"0","isalign":"0","islb":"0"}],fieldsselarr= [];
	...
	var c = {
		...
		subscribelist:function(){
			js.subscribe({
				title:'付款申请('+nowtabs.name+')',
				cont:'付款申请('+nowtabs.name+')的列表的',
				explain:'订阅[付款申请]的列表',
				objtable:a
			});
		},
		getacturl:function(act){
			return js.getajaxurl(act,'mode_finpay|input','flow',{'modeid':modeid});
		},
		...
		daoru:function(){
			window.managelistfinpay = a;
			addtabs({num:'daorufinpay',url:'flow,input,daoru,modenum=finpay',icons:'plus',name:'导入付款申请'});
		},
	...
	var bootparams = {
		...
		params:{atype:atype},
		columns:[{text:"申请人",dataIndex:"base_name",sortable:true},{text:"申请人部门",dataIndex:"base_deptname",sortable:true},{text:"单号",dataIndex:"sericnum"},{text:"付款编号",dataIndex:"num"},{text:"付款金额",dataIndex:"money",sortable:true},{text:"付款日期",dataIndex:"paydt",sortable:true},{text:"收款单位",dataIndex:"fullname"},{text:"收款银行",dataIndex:"openbank"},{text:"收款帐号",dataIndex:"cardid"},{text:"付款方式",dataIndex:"paytype"},{text:"状态",dataIndex:"statustext"},{
...
//[自定义区域end]
	...
	js.initbtn(c);
	var a = $('#viewfinpay_{rand}').bootstable(bootparams);
	c.init();
