...
$(document).ready(function(){
	{params}
	var modenum = 'kqerr',modename='打卡异常',isflow=1,modeid='51',atype = params.atype,pnum=params.pnum;
	if(!atype)atype='';if(!pnum)pnum='';
	var fieldsarr = [{"name":"\u7533\u8bf7\u4eba","fields":"base_name"},{"name":"\u7533\u8bf7\u4eba\u90e8\u95e8","fields":"base_deptname"},{"name":"\u5355\u53f7","fields":"sericnum"},{"fields":"uname","name":"\u7533\u8bf7\u4eba","fieldstype":"changeuser","ispx":"0","isalign":"0","islb":"0"},{"fields":"errtype","name":"\u5f02\u5e38\u7c7b\u578b","fieldstype":"rockcombo","ispx":"0","isalign":"0","islb":"1"},{"fields":"dt","name":"\u5f02\u5e38\u65e5\u671f","fieldstype":"date","ispx":"1","isalign":"0","islb":"1"},{"fields":"ytime","name":"\u5e94\u6253\u5361\u65f6\u95f4","fieldstype":"time","ispx":"0","isalign":"0","islb":"1"},{"fields":"explain","name":"\u8bf4\u660e","fieldstype":"textarea","ispx":"0","isalign":"0","islb":"1"}],fieldsselarr= [];
	...
	var c = {
		...
		subscribelist:function(){
			js.subscribe({
				title:'打卡异常('+nowtabs.name+')',
				cont:'打卡异常('+nowtabs.name+')的列表的',
				explain:'订阅[打卡异常]的列表',
				objtable:a
			});
		},
		getacturl:function(act){
			return js.getajaxurl(act,'mode_kqerr|input','flow',{'modeid':modeid});
		},
		...
		daoru:function(){
			window.managelistkqerr = a;
			addtabs({num:'daorukqerr',url:'flow,input,daoru,modenum=kqerr',icons:'plus',name:'导入打卡异常'});
		},
	...
	//表格参数设定
	var bootparams = {
		fanye:true,modenum:modenum,modename:modename,statuschange:false,tablename:jm.base64decode('a3FlcnI:'),
		url:c.storeurl(),storeafteraction:'storeaftershow',storebeforeaction:'storebeforeshow',
		params:{atype:atype},
		columns:[{text:"申请人",dataIndex:"base_name",sortable:true},{text:"申请人部门",dataIndex:"base_deptname",sortable:true},{text:"单号",dataIndex:"sericnum"},{text:"异常类型",dataIndex:"errtype"},{text:"异常日期",dataIndex:"dt",sortable:true},{text:"应打卡时间",dataIndex:"ytime"},{text:"说明",dataIndex:"explain"},{text:"状态",dataIndex:"statustext"},{
...
//[自定义区域end]
	...
	js.initbtn(c);
	var a = $('#viewkqerr_{rand}').bootstable(bootparams);
	c.init();
