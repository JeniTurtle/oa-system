...
$(document).ready(function(){
	...
	var c = {
		...
		daoru:function(){
			window.managelistcarmrese = a;
			addtabs({num:'daorucarmrese',url:'flow,input,daoru,modenum=carmrese',icons:'plus',name:'导入车辆预定'});
		},
	...
	//表格参数设定
	var bootparams = {
		fanye:true,modenum:modenum,modename:modename,statuschange:false,tablename:jm.base64decode('Y2FybXJlc2U:'),
		url:c.storeurl(),storeafteraction:'storeaftershow',storebeforeaction:'storebeforeshow',
		params:{atype:atype},
		columns:[{text:"申请人",dataIndex:"base_name",sortable:true},{text:"申请人部门",dataIndex:"base_deptname",sortable:true},{text:"单号",dataIndex:"sericnum"},{text:"使用者",dataIndex:"usename"},{text:"使用人数",dataIndex:"useren"},{text:"开始时间",dataIndex:"startdt"},{text:"截止时间",dataIndex:"enddt"},{text:"目的地",dataIndex:"address"},{text:"线路",dataIndex:"xianlines"},{text:"车牌号",dataIndex:"carnum"},{text:"驾驶员",dataIndex:"jianame"},{text:"起始公里数",dataIndex:"kmstart"},{text:"结束公里数",dataIndex:"kmend"},{text:"归还时间",dataIndex:"returndt"},{text:"说明",dataIndex:"explain"},{text:"状态",dataIndex:"statustext"},{
...
//[自定义区域end]
	...
	js.initbtn(c);
	var a = $('#viewcarmrese_{rand}').bootstable(bootparams);
	c.init();
