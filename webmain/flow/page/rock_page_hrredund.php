...
$(document).ready(function(){
	{params}
	var modenum = 'hrredund',modename='离职申请',isflow=1,modeid='33',atype = params.atype,pnum=params.pnum;
	if(!atype)atype='';if(!pnum)pnum='';
	var fieldsarr = [{"name":"\u7533\u8bf7\u4eba","fields":"base_name"},{"name":"\u7533\u8bf7\u4eba\u90e8\u95e8","fields":"base_deptname"},{"name":"\u5355\u53f7","fields":"sericnum"},{"fields":"applyname","name":"\u7533\u8bf7\u4eba","fieldstype":"changeuser","ispx":"0","isalign":"0","islb":"0"},{"fields":"ranking","name":"\u804c\u4f4d","fieldstype":"text","ispx":"1","isalign":"0","islb":"1"},{"fields":"applydt","name":"\u7533\u8bf7\u65e5\u671f","fieldstype":"date","ispx":"1","isalign":"0","islb":"1"},{"fields":"entrydt","name":"\u5165\u804c\u65e5\u671f","fieldstype":"text","ispx":"0","isalign":"0","islb":"1"},{"fields":"redundtype","name":"\u79bb\u804c\u7c7b\u578b","fieldstype":"rockcombo","ispx":"1","isalign":"0","islb":"1"},{"fields":"quitdt","name":"\u79bb\u804c\u65e5\u671f","fieldstype":"date","ispx":"1","isalign":"0","islb":"1"},{"fields":"redundreson","name":"\u79bb\u804c\u539f\u56e0","fieldstype":"textarea","ispx":"1","isalign":"0","islb":"1"},{"fields":"explain","name":"\u8bf4\u660e","fieldstype":"textarea","ispx":"1","isalign":"0","islb":"1"}],fieldsselarr= [];
	...
	var c = {
		...
		subscribelist:function(){
			js.subscribe({
				title:'离职申请('+nowtabs.name+')',
				cont:'离职申请('+nowtabs.name+')的列表的',
				explain:'订阅[离职申请]的列表',
				objtable:a
			});
		},
		getacturl:function(act){
			return js.getajaxurl(act,'mode_hrredund|input','flow',{'modeid':modeid});
		},
		...
		daoru:function(){
			window.managelisthrredund = a;
			addtabs({num:'daoruhrredund',url:'flow,input,daoru,modenum=hrredund',icons:'plus',name:'导入离职申请'});
		},
	...
	//表格参数设定
	var bootparams = {
		fanye:true,modenum:modenum,modename:modename,statuschange:false,tablename:jm.base64decode('aHJyZWR1bmQ:'),
		url:c.storeurl(),storeafteraction:'storeaftershow',storebeforeaction:'storebeforeshow',
		params:{atype:atype},
		columns:[{text:"申请人",dataIndex:"base_name",sortable:true},{text:"申请人部门",dataIndex:"base_deptname",sortable:true},{text:"单号",dataIndex:"sericnum"},{text:"职位",dataIndex:"ranking",sortable:true},{text:"申请日期",dataIndex:"applydt",sortable:true},{text:"入职日期",dataIndex:"entrydt"},{text:"离职类型",dataIndex:"redundtype",sortable:true},{text:"离职日期",dataIndex:"quitdt",sortable:true},{text:"离职原因",dataIndex:"redundreson",sortable:true},{text:"说明",dataIndex:"explain",sortable:true},{text:"状态",dataIndex:"statustext"},{
...
//[自定义区域end]
	...
	js.initbtn(c);
	var a = $('#viewhrredund_{rand}').bootstable(bootparams);
	c.init();
