...
$(document).ready(function(){
	{params}
	var modenum = 'carms',modename='车辆信息登记',isflow=0,modeid='58',atype = params.atype,pnum=params.pnum;
	if(!atype)atype='';if(!pnum)pnum='';
	var fieldsarr = [{"name":"\u7533\u8bf7\u4eba","fields":"base_name"},{"name":"\u7533\u8bf7\u4eba\u90e8\u95e8","fields":"base_deptname"},{"name":"\u5355\u53f7","fields":"sericnum"},{"fields":"carid","name":"\u8f66\u8f86","fieldstype":"select","ispx":"0","isalign":"0","islb":"1"},{"fields":"otype","name":"\u767b\u8bb0\u7c7b\u578b","fieldstype":"rockcombo","ispx":"1","isalign":"0","islb":"1"},{"fields":"startdt","name":"\u5f00\u59cb\u65e5\u671f","fieldstype":"date","ispx":"1","isalign":"0","islb":"1"},{"fields":"enddt","name":"\u622a\u6b62\u65e5\u671f","fieldstype":"date","ispx":"1","isalign":"0","islb":"1"},{"fields":"jianame","name":"\u9a7e\u9a76\u5458","fieldstype":"changeusercheck","ispx":"0","isalign":"0","islb":"1"},{"fields":"unitname","name":"\u5bf9\u5e94\u540d\u79f0","fieldstype":"text","ispx":"0","isalign":"0","islb":"1"},{"fields":"money","name":"\u91d1\u989d","fieldstype":"number","ispx":"1","isalign":"0","islb":"1"},{"fields":"address","name":"\u5730\u70b9","fieldstype":"text","ispx":"0","isalign":"0","islb":"1"},{"fields":"explain","name":"\u8bf4\u660e","fieldstype":"textarea","ispx":"0","isalign":"0","islb":"1"},{"fields":"optname","name":"\u767b\u8bb0\u4eba","fieldstype":"text","ispx":"0","isalign":"0","islb":"1"},{"fields":"optdt","name":"\u767b\u8bb0\u65f6\u95f4","fieldstype":"text","ispx":"0","isalign":"0","islb":"1"},{"fields":"ztname","name":"\u72b6\u6001","fieldstype":"text","ispx":"0","isalign":"0","islb":"1"}],fieldsselarr= [];
	...
	var c = {
		...
		getacturl:function(act){
			return js.getajaxurl(act,'mode_carms|input','flow',{'modeid':modeid});
		},
		//查看切换
		...
		daoru:function(){
			window.managelistcarms = a;
			addtabs({num:'daorucarms',url:'flow,input,daoru,modenum=carms',icons:'plus',name:'导入车辆信息登记'});
		},
	...
	//表格参数设定
	var bootparams = {
		fanye:true,modenum:modenum,modename:modename,statuschange:false,tablename:jm.base64decode('Y2FybXM:'),
		url:c.storeurl(),storeafteraction:'storeaftershow',storebeforeaction:'storebeforeshow',
		params:{atype:atype},
		columns:[{text:"车辆",dataIndex:"carid"},{text:"登记类型",dataIndex:"otype",sortable:true},{text:"开始日期",dataIndex:"startdt",sortable:true},{text:"截止日期",dataIndex:"enddt",sortable:true},{text:"驾驶员",dataIndex:"jianame"},{text:"对应名称",dataIndex:"unitname"},{text:"金额",dataIndex:"money",sortable:true},{text:"地点",dataIndex:"address"},{text:"说明",dataIndex:"explain"},{text:"登记人",dataIndex:"optname"},{text:"登记时间",dataIndex:"optdt"},{text:"状态",dataIndex:"ztname"},{
...
//[自定义区域end]
	...
	js.initbtn(c);
	var a = $('#viewcarms_{rand}').bootstable(bootparams);
	c.init();
