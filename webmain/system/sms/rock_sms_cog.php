...
$(document).ready(function(){
	...
	var c={
		...
		save:function(){
			...
			if(da.sms_qmnum=='' && lxs!=''){
				js.msg('msg','使用短信签名不能为空，请输入如：琢瑜OA，更多查看帮助');
				return;
			}
...
<div  style="padding:10px;">
	...
	<tr>
		...
		<td class="tdinput"><select id="sms_dirtype_{rand}" style="width:200px" class="form-control"><option value="">琢瑜OA短信服务</option><option value="alisms">阿里云(短信服务)</option></select></td>
	</tr>
