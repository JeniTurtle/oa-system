...
class beifenClassAction extends Action
{
	...
	*/
	...
	public function chushuserAjax()
	{
		...
		$users	= "'diaochan','zhangfei','daqiao','xiaoqiao','zhaozl','rock','jouryu'";
		$dbs	= m('admin');
		$dba	= m('dept');
