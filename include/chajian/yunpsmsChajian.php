...
*	开发帮助地址：http://www.jouryu.com/view_yunpsms.html
*/
class yunpsmsChajian extends Chajian{
	...
	*	$cans 模版中的参数数组
	*	例子：c('mysms')->send('15800000000,15800000001','琢瑜OA', 'default', array('modename'=>'模块名','sericnum'=>'单号')); 这例子是不需要自己调用，只要短信设置下切换为“我的短信服务”就可以了
	*/
